...
@router.get(
    "/tenants/{tenant_id}/audit", dependencies=[Depends(_require_agent_user)]
)
async def audit(tenant_id: str, limit: int = 100) -> list[dict]:
    return await _svc().list_audit(tenant_id, limit)
